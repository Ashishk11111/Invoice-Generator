...
// const AnimatedHomepage: React.FC<AnimatedHomepageProps> = ({ formData, billingData, handleChange, handleBillChange, handleDownload, descriptions, handleDescriptionChange, handleAddDescription, handleAddDetail, handleRemoveDescription, handleRemoveDetail }) => {
//   const datekeys = ["date", "datePO", "DispatchedDate"]
//   const MAX_ROWS = 13;

//   // In your state or derived variable:
//   const totalRowsUsed = Object.values(descriptions).reduce(
//     (acc, val) => acc + val.details.length,
//     0
//   );

//   const shouldShowSaveButton = totalRowsUsed >= MAX_ROWS;
//   return (
//     <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-6">

//       {/* Background Image with Opacity */}
//       <div className="absolute inset-0 bg-gradient-to-br from-red-100 via-orange-50 to-yellow-100 opacity-40 z-0" />
//       <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05')] bg-cover bg-center opacity-20 z-0" />
//       <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-orange-500/10 opacity-70 z-0" />

//       {/* Floating Coat of Arms - Adjusted for mobile */}
//       <div className="fixed top-4 right-4 z-50 animate-fade-in">
//         <motion.div
//           className="bg-white/90 backdrop-blur-md p-2 sm:p-4 rounded-full shadow-2xl border-2 sm:border-4 border-red-500/30"
//           animate={{
//             rotate: [0, 5, -5, 0],
//             scale: [1, 1.05, 1]
//           }}
...
//         className="relative z-10 max-w-5xl w-full mx-2 sm:mx-4 bg-gradient-to-br from-white via-red-50 to-orange-50 backdrop-blur-md rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-red-200/50 overflow-hidden"
//       >
//         {/* Company Header */}
//         <div className="bg-gradient-to-r from-red-600 via-red-500 to-orange-500 p-1 rounded-t-2xl sm:rounded-t-3xl">
//           <div className="bg-gradient-to-br from-white via-red-50 to-orange-50 p-4 sm:p-6 rounded-t-2xl sm:rounded-t-3xl">
//             <motion.div
//               className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 space-y-4 sm:space-y-0"
...
//                 />
//                 <div>
//                   <h1 className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">
//                     Mohan Enterprises
//                   </h1>
//                   <p className="text-gray-700 font-medium text-xs sm:text-base leading-tight">
//                     Deals in Sales & Service and Projects, Design, Supply, Installation & Commissioning
//                   </p>
//                 </div>
//               </div>

//               <div className="text-left sm:text-right space-y-1 w-full sm:w-auto">
//                 <div className="flex items-center justify-start sm:justify-end space-x-2 text-red-600 font-semibold text-sm sm:text-base">
//                   <Phone className="w-3 h-3 sm:w-4 sm:h-4" />
//                   <span>+91-8076884285</span>
//                 </div>
//                 <div className="text-orange-600 font-medium text-sm">9953366595</div>
//                 <div className="text-red-500 font-medium text-sm">9528746236</div>
//               </div>
//             </motion.div>

//             <motion.div
//               className="border-t-2 border-gradient-to-r from-red-300 to-orange-300 pt-3"
//               initial={{ opacity: 0 }}
//               animate={{ opacity: 1 }}
//               transition={{ duration: 0.6, delay: 0.4 }}
//             >
//               <div className="text-xs sm:text-sm text-gray-700 mb-2">
//                 <span className="font-bold text-red-600">GSTIN:</span> 07CEGPS6132F1ZG
//               </div>
//               <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
//                 <span className="font-semibold text-orange-600">Specializing in:</span> Kirloskar, Danfoss, Infos, Manik, Parker, Super Valve, Alfa Laval PHE Chiller & Condenser
//               </p>
//               <p className="text-xs text-gray-500 mt-2 leading-relaxed">
//                 All Type of Refrigeration Plant & Beer Plant, Ice Plant, Air Conditioning, Chilling Plant, Cold Storage,
//                 Make Alfa Level PHE Type Ammonia & Freon Condenser & Chiller All Type of Pipe Lines, Insulation & Ducting
//               </p>
//             </motion.div>
//           </div>
//         </div>
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.6, delay: 0.2 }}
//             className="text-2xl sm:text-3xl font-extrabold mb-6 bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent tracking-wide text-center"
//           >
//             Invoice Generator
//           </motion.h2>
...
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-3 p-4 border-1 border-blue-700 hover:border-blue-500 transition-all duration-500 rounded-lg shadow-md bg-blue-50 space-y-2 hover:shadow-[0_0_12px_rgba(59,130,246,0.6)] mb-4"
//           >
...
//               >
//                 <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-600 to-cyan-500 rounded-lg blur opacity-0 group-hover:opacity-25 transition duration-300"></div>
//                 <div className="relative">
//                   <label className="block text-sm font-medium text-red-700 mb-2 capitalize">
//                     {key.replace(/([A-Z])/g, ' $1').trim()}
//                   </label>
//                   <motion.input
//                     type={datekeys.includes(key) ? "date" : "text"}
//                     name={key}
//                     // min={datekeys.includes(key) ? "1900-01-01" : undefined}
//                     // max={datekeys.includes(key) ? "2099-12-31" : undefined}
//                     value={billingData[key]}
//                     placeholder={key.replace(/([A-Z])/g, ' $1').trim()}
//                     className="w-full p-2 rounded-lg border-2 border-red-200 bg-gradient-to-r from-white to-red-50 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition-all duration-200 placeholder-red-400/70 text-gray-700 text-sm sm:text-base"
...
//                 transition={{ duration: 0.5, delay: 0.1 * index }}
//               >
//                 <div className="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-orange-500 rounded-lg blur opacity-0 group-hover:opacity-25 transition duration-300"></div>
//                 <div className="relative">
//                   <label className="block text-sm font-medium text-red-700 mb-2 capitalize">
//                     {key.replace(/([A-Z])/g, ' $1').trim()}
//                   </label>
...
//           {/* Descriptions */}
//           {Object.entries(descriptions).map(([key, desc], i) => (
...
//                     value={detail}
//                     onChange={(e) =>
//                       handleDescriptionChange(key, "details", e.target.value, idx)
//                     }
...
//                       className="text-red-500 text-sm px-2 py-1 bg-red-100 rounded"
//                     >
//                       - Remove
//                     </button>
//                   )}
...
//                 className="mb-2 text-sm bg-blue-100 p-1 rounded"
//               >
//                 + Add Detail
//               </button>
...
//                 className="mb-2 block w-full border p-1 rounded"
//               />
...
//             }}
//             whileTap={{ scale: 0.95 }}
//             className="mt-6 sm:mt-8 w-full bg-gradient-to-r from-red-600 via-red-500 to-orange-500 text-white font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-xl hover:from-red-700 hover:to-orange-600 shadow-xl transition-all duration-300 text-base sm:text-lg tracking-wide"
//           >
...
import { motion } from 'framer-motion';
import { Phone, MapPin, Mail, Moon, Sun, Plus, Minus, Download } from 'lucide-react';
